...
// MIT Class https://www.youtube.com/watch?v=HtSuA80QTyo
// https://www.filipekberg.se/2014/02/10/understanding-peak-finding/

// C:\DVT\.NET\PeakFindindUnitTests\PeakFindindUnitTests\bin\Debug
/*
 set MSTEST=C:\Program Files (x86)\Microsoft Visual Studio\2017\Professional\Common7\IDE\mstest
 "%MSTEST%" /testcontainer:PeakFindindUnitTests.dll
 */
namespace PeakFindindUnitTests
{
    ...
    public class UnitTePeakFinderUnitTests
    {
        ...
        public void FindPeakElement_OnTheRight()
        {
            ...
            l = new List<int> { 1, 2, 3, 4, 1 };// Peak is 4[3]
